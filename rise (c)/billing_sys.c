//smart retail billing system (accept the multiple product, calculate the bill, apply tax and discount, generate analystical summary) (rule: grocery-5% tax, electronic-18% tax and clothing-12% tax) (if bill is greater than or equal to 5000 than 20% discount, if bill greater than or equals to 3000 than 10% discount, if bill is less than 3000 than no discount)(quantity can't be zero or negative, price must be greater than 0, invalid category than print ignore) (total bill amount, highest price items, total tax collected, count of items per category)
